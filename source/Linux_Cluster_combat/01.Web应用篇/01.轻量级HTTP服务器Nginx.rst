...
远过期。 “Cache-Control”头标的值由您指定的时间来决定。
负数：Cache-Control: no-cache。 正数或零： Cache-Control:
max-age=#，#为您指定时间的秒数。
...
.. |image0| image:: ../../_static/nginx00001.PNG
.. |image1| image:: ../../_static/nginx000001.png
.. |image2| image:: ../../_static/FsatCGI001.PNG
