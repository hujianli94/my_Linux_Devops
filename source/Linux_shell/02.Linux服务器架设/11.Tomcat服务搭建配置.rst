...
.. figure:: ../../_static/tomcat3.png
   :alt: 

Tomcat多实例配置
----------------

多虚拟主机：nginx 多个Server标签（域名，ip，端口） 进程数量固定
master+worker 多实例（多进程）：同一个程序启动多次，分为两种情况:
...
在浏览器访问，进行测试 检查多实例的启动 |image3| |image4|
...
.. |image0| image:: ../../_static/tomcat01.png
.. |image1| image:: ../../_static/tomcat1.png
.. |image2| image:: ../../_static/tomcat2.1.png
.. |image3| image:: ../../_static/tomcat5.png
.. |image4| image:: ../../_static/tomcat6.png
