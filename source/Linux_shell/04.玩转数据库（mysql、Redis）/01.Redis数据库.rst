...
.. figure:: ../../_static/db_comp.png
   :alt: 

reids和memcached的比较
----------------------

.. figure:: ../../_static/redis-memcached.png
   :alt: 
...
-  存储路径：根据“redis.conf”下的dir以及‘rdbfilename’来制定的，默认是
...
-  开启和关闭：默认是关闭的。如果想开启，那么修改redis.conf中的‘appendonly
   yes’ 就可以了
...
-  存储路径：根据redis.conf下的dir以及appendfilename来指定的。默认是
...
参考文献： http://redisdoc.com/index.html
...
参考文献 https://www.cnblogs.com/liuweida/p/11817081.html
...
.. |image0| image:: ../../_static/redis_master_salve001.png
