...
http://www.shookm.com/index.php/2019/04/26/jenkins%E6%9B%B4%E6%8D%A2%E8%87%AA%E5%AE%9A%E4%B9%89%E4%B8%BB%E9%A2%98/
...
::
    ...
    deleteDir：删除当前目录.deleteDir是一个无参步骤，删除的是当前工作目录。通常它与dir步骤一起使用，用于删除指定目录下的内容。

    dir：切换到目录.默认pipeline工作在工作空间目录下，dir步骤可以让我们切换到其他目录。
...
3.4.4 jenkins+harbor+k8s CICD示例
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. figure:: ../_static/pipeline_cron0001.png
   :alt: 
...
.. figure:: ../_static/webhook_gitlab001.png
   :alt: 

.. figure:: ../_static/webhook_gitlab002.png
   :alt: 

在Integrations配置页的相应输入框中粘贴上一步中Jenkins暴露的webhook及相应的Secret
token如下

.. figure:: ../_static/gitlab_webhook003.png
   :alt: 
...
.. figure:: ../_static/webhook_test0001.png
   :alt: 
...
.. figure:: ../_static/webhook_gitlan0003.png
   :alt: 
...
5.3.1 Jenkins + gitee +webhook
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

https://my.oschina.net/attacker/blog/4456540

5.4 在pipeline中实现GitLab trigger
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
5.5 使用Generic Webhook Trigger插件实现触发
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. figure:: ../_static/jenkins_GWT0001.png
   :alt: 
...
5.5.3 根据请求参数值判断是否触发Jenkins项目执行
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
https://blog.csdn.net/weixin\_42562106/article/details/107144445?utm\_medium=distribute.pc\_relevant.none-task-blog-searchFromBaidu-2.control&depth\_1-utm\_source=distribute.pc\_relevant.none-task-blog-searchFromBaidu-2.control
...
.. figure:: ../_static/gitlab-token001.png
   :alt: 

首先在\ ``系统管理``-``系统配置``\ 中配置好连接Gitlab的信息如下

.. figure:: ../_static/jenkins-gitlab0001.png
   :alt: 
...
.. figure:: ../_static/webhook_gitlab_00004.png
   :alt: 

.. figure:: ../_static/webhook_gitlab0005.png
   :alt: 
...
.. figure:: ../_static/gitlab_webhook0006.png
   :alt: 
...
.. figure:: ../_static/duo_branch_pipeline001.png
   :alt: 
...
.. figure:: ../_static/duo_branch0002.png
   :alt: 
...
.. figure:: ../_static/duo_branch0003.png
   :alt: 
...
.. figure:: ../_static/duo_branch0004.png
   :alt: 
...
.. figure:: ../_static/pipeline_parameters00001.png
   :alt: 
...
.. figure:: ../_static/pipeline_parameters00002.png
   :alt: 
...
.. figure:: ../_static/pipeline_parameters00004.png
   :alt: 
...
.. figure:: ../_static/jenkins_hu_parameters0001.png
   :alt: 

.. figure:: ../_static/jenkins_hu_parameters0002.png
   :alt: 
...
.. figure:: ../_static/jenkins_parameters0003.png
   :alt: 

.. figure:: ../_static/jenkins_parameter00004.png
   :alt: 
...
.. figure:: ../_static/jenkins_parameter00005.png
   :alt: 
...
.. figure:: ../_static/jenkins_simple0001.png
   :alt: 
...
.. figure:: ../_static/jenkins_sample0002.png
   :alt: 
...
.. figure:: ../_static/jenkins_20201215001.png
   :alt: 

.. figure:: ../_static/jenkins_20201215002.png
   :alt: 
...
.. figure:: ../_static/jenkins_202012150003.png
   :alt: 

.. figure:: ../_static/jenkins_202012150004.png
   :alt: 
...
.. figure:: ../_static/jenkins_202012150005.png
   :alt: 

.. figure:: ../_static/jenkins_202012150006.png
   :alt: 
...
.. figure:: ../_static/jenkins_secret0001.png
   :alt: 

.. figure:: ../_static/jenkins_secret0002.png
   :alt: 
...
https://blog.csdn.net/qq\_31977125/article/details/83861714
...
如果要求安全级别高，则应该提前将所有受控机器的fingerprint放到主控机器的know\_hosts文件中。

（3）在Jenkins上进入Manage Jenkins→Global Tool
Configuration→Ansible配置页面，配置Ansible的执行路径

.. figure:: ../_static/jenkins_ansible0004.png
   :alt: 
...
.. figure:: ../_static/jenkins_ansible0005.png
   :alt: 
...
其中ansible\_ssh\_user和，ansible\_ssh\_pass变量分别指SSH的用户名和密码；

ansible\_become\_method变量指执行任务时切换权限的方法。
...
.. figure:: ../_static/jenkins_sendm0001.png
   :alt: 

.. figure:: ../_static/jenkins_sendm0002.png
   :alt: 

.. figure:: ../_static/jenkins_sendm0004.png
   :alt: 
...
.. figure:: ../_static/jenkins_email00001.png
   :alt: 
...
.. figure:: ../_static/jenkins_mail0003.png
   :alt: 
...
使用HTTP
Request插件（https://plugins.jenkins.io/http\_request），我们能在Jenkins
...
.. figure:: ../_static/jenkins_options001.png
   :alt: 
...
.. figure:: ../_static/jenkins_quanxian0001.png
   :alt: 
...
.. figure:: ../_static/jenkins_monitor0001.png
   :alt: 
...
.. figure:: ../_static/jenkins_prometheus001.png
   :alt: 
...
.. figure:: ../_static/jenkins_prumetheus0002.png
   :alt: 
...
.. figure:: ../_static/jenkins_proumetheus0002.png
   :alt: 
...
16.4.1 JENKINS\_HOME介绍
^^^^^^^^^^^^^^^^^^^^^^^^

Jenkins的所有数据都是存放在文件中的，所以，Jenkins备份其实就是备份JENKINS\_HOME目录。

.. figure:: ../_static/jenkins_tree0001.png
   :alt: 
...
如果启动 Jenkins 时没有指定 JENKINS\_HOME 环境变量，那么 Jenkins
将在当前用户目录下创建一个.jenkins目录作为JENKINS\_HOME目录。

笔者强烈建议启动Jenkins时明确指定JENKINS\_HOME目录。比如这样启动：
...
.. figure:: ../_static/jenkins_backup1221.png
   :alt: 
...
.. figure:: ../_static/jenkins_backup1221002.png
   :alt: 
...
.. figure:: ../_static/jenkins_restor0001.png
   :alt: 
...
.. figure:: ../_static/jenkins_hanhua0001.png
   :alt: 
...
.. figure:: ../_static/jenkins_ansible0001.png
   :alt: 

-  Prometheus server负责监控数据收集和存储。
-  Prometheus alert
   manager负责根据告警规则进行告警，可集成多种告警通道。
-  node-exporter（https://github.com/prometheus/node\_exporter）的作用是从机器上读取指标数据，然后暴露一个HTTP服务，Prometheus就是从这个服务中收集监控指标数据的。Prometheus官方还提供了各种各样的exporter。
...
.. figure:: ../_static/jenkins_ansible_dingding001.png
   :alt: 
...
.. figure:: ../_static/jenkins_ansible0002.png
   :alt: 
...
.. figure:: ../_static/jenkins_ansible_install0003.png
   :alt: 
...
.. figure:: ../_static/jenkins_ansibleo00003.png
   :alt: 
